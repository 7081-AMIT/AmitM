  ...
  const Pver = ({navigation}) => {
    ...
    return (
      <SafeAreaView>
       ...
       <Text style={styles.txt11}>Please enter the 6-digit verification code   </Text>
       <Text style={styles.txt11}>that was sent to +91-99366595085. The</Text>
       <Text style={styles.txt11}>code is valid for 3 minutes.</Text>
        ...
        <TextInput placeholder='Enter Phone Number' placeholderTextColor={'#8E8E8E'}
